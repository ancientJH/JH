function [R, Psi_plus_rec] = Assemble_Ru(Sol_u, Sol_d, Coord, IEN, LM_u, LM_d, elementType, ...
...
for ielem = 1:nElements
    ...
    [r_e, Psi_plus_rec] = Element_Ru(localCoord, localSol, elementType, ...
    constitutive, body_force, current_load_step, nQuad, ielem, Psi_plus_rec, Psi_plus_old);
    R(LM_u(:, ielem)) = R(LM_u(:, ielem)) + r_e;
end
